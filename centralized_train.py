...
def parse_opt(known=False):
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default=os.path.join(ROOT_DIR, "yolov5s.pt"),
    ...
    parser.add_argument(
        "--data",
        type=str,
        default=os.path.join(ROOT_DIR, "data/data.yaml"),
        help="dataset.yaml path",
    )
    parser.add_argument(
        "--hyp",
        type=str,
        default=os.path.join(YOLO_DIR, "data/hyps/hyp.scratch-low.yaml"),
    ...
    parser.add_argument(
        "--project",
        default=os.path.join(ROOT_DIR, "training/centralized_learning"),
